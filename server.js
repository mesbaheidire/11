  ...
  try {
    ...
    try {
      ...
      if (isHook) {
        ...
        - "لافاااااااار باطل والله 🧨💥"
        - "افاااااااااااااااار خطيرة 🔥😱"

        🎨 قاموس الكلمات المسموح خلطها:
        - عبارات الإثارة: الحححححق، الحـــــــــق، اجريييي، اجرييييييي، خاوتي، خاوتنا، والله العظيم
        ...
        - دعوات الفعل: ما تراطيش، ما تفوتهاش، اجري بكري، الكمية شويا، الأكثر طلباً
