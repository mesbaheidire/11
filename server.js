...
- "$100/400" أو "$90/400" أو "$80/400" (مع أو بدون كود)
- "ASUА60" أو "ASUA45" (أكواد مع أحرف وأرقام)
- "100X8PPC $100/400" (كود + مبلغ)
- "ZNQ060C $429-$60" (قد تكون قسيمة بائع)
- "عرض متجر البائع: ABC123"
- "خصم من متجر البائع: XYZ789"

قواعس البحث الصارمة:
1. ابحث عن صيغ مبالغ: $XXX/XXX أو $XXX-$XX (هذه غالباً قسائم بائع)
2. ابحث عن كلمات مثل: "قسيمة البائع", "قسيمة متجر", "عرض متجر", "خصم البائع"
3. الأكواد: مزيج من أحرف كبيرة وأرقام (مثل: 100X8PPC, ASUА60, SUV5QSCYTUHK)
4. إذا رأيت صيغة مبالغ ($XXX/XXX) متبوعة بكود → هذه قسيمة بائع
5. تجاهل الأكواد التي تأتي تحت كلمة "كوبون" الصريحة (مثل ZNQ040) إلا إذا كانت مع صيغة مبلغ

أمثلة من الصور الحقيقية:
- "$90/400" → قسيمة بائع (حتى لو لم يكن هناك كود محدد)
- "100X8PPC $100/400" → 100X8PPC
- "ASUА60" مع "$429-$60" → ASUА60

النص:
${text}

استخرج أول قسيمة بائع واضحة (كود أو مبلغ أو كليهما).
