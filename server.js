  ...
  try {
    ...
    try {
      ...
      if (isHook) {
        ...
        ✅ الأسلوب المطلوب (نموذج حقيقي يجب أن يحاكيه ردك بدقة):
        "الحححححق اقل سعر للهاتف لافــــــــــــار ما تراطيش 🔥 اجريييييييي دير لافاااار راه بسعر مريييييقل نسخة عاااالمية 🔥🔥😍😍"

        قواعد إلزامية صارمة:
        1. اخلط بين 3-5 عبارات قصيرة مع بعضها (الحق، لافار، مريقل، اجري، باطل، بـالكاش، تستاهل، نسخة عالمية، الكمية محدودة، ما تراطيش، خطيرة، نااار...).
        2. **مطّ الحروف داخل الكلمات بشكل مبالغ فيه** (مثل: لافـــــــــــــار، الحححححححق، مريييييييقل، اجريييييييي، عاااااالمية).
        3. أضف 3-6 إيموجي مكررة وموزعة داخل النص (🔥💥⚡️😍🤩💸⚠️🚨💎🧨🛒).
        4. اكتب كل شيء في **سطر واحد فقط** (بدون \\n).
        5. الطول بين 12 و 25 كلمة.
        6. ممنوع ذكر السعر بالأرقام، ممنوع كتابة الرابط، ممنوع كلمة "تخفيض" (لأنها ستظهر بعدها).
        7. ممنوع الشرح أو المقدمات أو علامات التنسيق (* # _).
        8. ممنوع تكرار اسم المنتج كاملاً — استعمل وصف مختصر (الهاتف، الساعة، السماعة، حسب المنتج).
        9. أرجع المقدمة فقط بدون أي إضافات.
...
app.post('/api/generate-algerian-hook', async (req, res) => {
  try {
    ...
    const fallbackHooks = [
      "الحححححق اقل سعر لافــــــــــار ما تراطيش 🔥 اجريييييي راه بسعر مريييقل 🔥😍",
      "بـــــــاااطل بــــاااطل 💥 لافااااار خطييييير ما تتفوتش الفرصة الكميييية محدودة ⚠️🔥",
      "اجرييييييي يا الباااطل 🚨 لافـــــــــار نااااار سعر مرررررريقل ما يتكررش 💸🔥",
      "الحححححححق نسخة عاااالمية 💎 سومة باااااطل ما تراطيش الفرصة 🔥🤩⚡️",
      "لافـــــــار باااااطل 🧨 جبتلكم عرض يهبـــــــــل اجرييي قبل ما تخلص 🔥💥",
      "والله العظييييم باااااطل 😱 سومة مريييقل ونسخة خطييييرة ما تفوتكمش 🔥💎",
      "خاااااوتنا لافار خطييييير 🚨 الكميييية قلييييلة اجريييي قبل غييرك 🔥🛒",
      "بـــــــــــــاطل 📉 سعر ما يتصدقش لافااار باااطل اشري وفرحلي قلبي 🤩🔥💸",
      "لافـــــــــار تاع الصح 💥 جودة عاااالية بسومة مرررررريقل ما تتفوتش ⚡️🔥",
      "اجريييييييي يا خاوتي 🚨 الباااااطل وصل لافار ناااار اقل سعر بالكاش 🔥💎"
    ];
