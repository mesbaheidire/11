  ...
  try {
    ...
    try {
      ...
      if (isHook) {
        ...
        ✅ أمثلة قصيرة بالأسلوب المطلوب (يجب أن يكون ردك مشابهاً في الطول):
        - "الحححححق لافـــــار ما تراطيش 🔥😍"
        - "اجريييي راه مريييييقل بصح 💸🔥"
        - "لافــــار خطيرة الكمية شويا ⚡️🚨"
        - "نسخة عاااالمية بسعر باطل 🔥💎"

        قواعد إلزامية صارمة:
        1. **قصيرة جداً**: من 4 إلى 8 كلمات فقط.
        2. **مطّ الحروف داخل الكلمات بشكل مبالغ فيه** (لافـــــار، الحححححق، مريييييقل، اجريييييي، عاااالمية).
        3. أضف 2-4 إيموجي فقط (🔥💥⚡️😍🤩💸⚠️🚨💎🧨).
        4. **سطر واحد فقط** بدون \\n.
...
app.post('/api/generate-algerian-hook', async (req, res) => {
  try {
    ...
    const fallbackHooks = [
      ...
      "لافــــار خطيرة الكمية شويا ⚡️🚨",
      "نسخة عاااالمية بسعر باطل 🔥💎",
      "بـــاااطل والله العظييييم 😱🔥",
      "لافار نااااار ما تفوتهاش 🧨💥",
      "سومة مريييييقل اجري بكري 💸⚡️",
